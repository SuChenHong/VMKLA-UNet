...
from utils.util import save_imgs, NativeScalerWithGradNormCount as NativeScaler
from utils.util import adjust_learning_rate, find_image
...
def train_one_epoch(train_loader,
    ...
    for iter, data in enumerate(train_loader):
        ...
        """
        if the encoder depth is [2, 2, 2, 2], you can use the two commented lines below.
        """
        # loss.backward()
        # optimizer.step()
